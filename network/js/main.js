...
function nodeActive(a) {
    ...
    if (f.attributes) {
        ...
        if (image_attribute) {
        	...
        	$GP.info_name.html("<div><span onmouseover=\"sigInst._core.plotter.drawHoverNode(sigInst._core.graph.nodesIndex['" + b.id + '\'])" onmouseout="sigInst.refresh()"><a target="_blank" alt="Go to /r/' + b.label + '" href="http://reddit.com/r/' + b.label + '/">' + b.label + "</a></span></div>");
        }
